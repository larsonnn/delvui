    ...
    public class Plugin : IDalamudPlugin {
        ...
        private void SwapJobs() {
            _hudWindow = _clientState.LocalPlayer?.ClassJob.Id switch
            {
                ...
                //dont have packs yet
                Jobs.BLM => new UnitFrameOnlyHudWindow(_clientState, _pluginInterface, _dataManager, _gameGui, _jobGauges, _objectTable, _pluginConfiguration, _targetManager),
                Jobs.MCH => new UnitFrameOnlyHudWindow(_clientState, _pluginInterface, _dataManager, _gameGui, _jobGauges, _objectTable, _pluginConfiguration, _targetManager),
                Jobs.PLD => new UnitFrameOnlyHudWindow(_clientState, _pluginInterface, _dataManager, _gameGui, _jobGauges, _objectTable, _pluginConfiguration, _targetManager),
                Jobs.MNK => new UnitFrameOnlyHudWindow(_clientState, _pluginInterface, _dataManager, _gameGui, _jobGauges, _objectTable, _pluginConfiguration, _targetManager),
                ...
                Jobs.SCH => new UnitFrameOnlyHudWindow(_clientState, _pluginInterface, _dataManager, _gameGui, _jobGauges, _objectTable, _pluginConfiguration, _targetManager),
